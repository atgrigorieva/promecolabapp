    ...
    render(){
        return(
            <Container>
                <Header>
                    <Body>
                    <Title>Включение Спектрофотометра В-1200. Осмотр прибора. Шаг 1</Title>
                    </Body>
                </Header>
                <Content padder >
                    <View>
                ...
                <Footer>
                    <Left><Button onPress={() => this.props.navigation.navigate('inspectionOfDeviceStep2')}><Text>Шаг 2</Text></Button></Left>
