    ...
    render(){
        return(
            <Container>
                            ...
                            <View style={{flex:1, flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        При каждом включении Спектрофотометр В-1200 ТМ ЭКОВЬЮ проводит самодиагностику и самокалибровку.
                                    </Text>
                                    <Text style={{
                                        fontSize:15,
                                        marginBottom: 10
                ...
                <Footer>
                    <Left><Button onPress={() => this.props.navigation.navigate('Lamps')}><Text>Лампы</Text></Button></Left>
