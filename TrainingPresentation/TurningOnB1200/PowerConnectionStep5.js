    ...
    render(){
        return(
            <Container>
                <Header>
                    <Body>
                    <Title>Включение Спектрофотометра В-1200. Подключение к сети. Шаг 5</Title>
                    </Body>
                </Header>
                <Content padder >
                    <View>
                ...
                <Footer>
                    <Left><Button onPress={() => this.props.navigation.navigate('PowerConnectionStep6')}><Text>Шаг 6</Text></Button></Left>
